...
public static class PP
{
	...
	public const int XRES = 1200;
	public const int YRES = 600;
...
// 	public const double Lv = 30;
	...
	//Test
	public static Point At = new Point(30, -15, 0);
	public static Point E = new Point(60, 0, 1000);
	public static List<Point> Lights = new List<Point>() { new Point(-200, 500, 500)};
	public const double Lu = 100;
	public const double Lv = 50;
